fetch('https://api.airtable.com/v0/appyBFIZr0qBqv83r/Item?maxRecords=30&view=Grid%20view', {
            ...
            .then(function (data) {
                ...
                for (i in data.records) {
                    ...
                    row.insertCell(0).innerHTML = item.fields['fname'];
                    row.insertCell(1).innerHTML = item.fields['rname'];
                    row.insertCell(2).innerHTML = item.fields['name'];
                    row.insertCell(3).innerHTML = '<a href="#" id="buy1">' + '訂購' + '</a>';
                }
